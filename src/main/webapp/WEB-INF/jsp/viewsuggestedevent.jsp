...
<body>
	...
	<div class="container container-width">
		...
		<div class="collapse multi-collapse" id="multiCollapseExample1" style="margin-bottom: 15px;">
			<form:form action="viewSuggestedEvents" method="get" modelAttribute="eventModel">
				...
				<div class="card-header d-flex justify-content-between" style="font-size: 20px; font-weight: bold;">
					...
					<c:if test='${userRole.equalsIgnoreCase("Admin")}'>
						<c:if test="${!event.approvalStatus}">
							<a class="btn btn-success" href="eventApproved?eventId=${event.id}"
								style="color: #FFFFFF">Approve</a>
						</c:if>
						<c:if test="${event.approvalStatus}">
							<a class="btn btn-danger" href="eventRejected?eventId=${event.id}">Reject</a>
						</c:if>
					</c:if>
				</div>
				<div class="card-body">
