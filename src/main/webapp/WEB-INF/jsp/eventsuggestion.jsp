...
<body>
	<header>
		<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #0033A0;"> <a
				class="navbar-brand" style="color: #00B242" href="/home">Outreach</a>
	...
	<div class="container container-width">
		...
		<form:form modelAttribute="event" action="addSuggestEvent" method="post" class="needs-validation">
			<div class="form-group">
				<label for="activityType">Activity</label>
				<form:select placeholder="Select an activity" path="activityType" id="activityType" class="form-control"
					required="true">
			...
			<div class="form-group">
				...
				<form:input path="place" placeholder="Enter the venue place" class="form-control" id="place" />
				<br>
			...
			<div class="form-group">
				...
				<form:textarea path="benificiary" placeholder="Who is benefitted from the event" class="form-control"
					id="benificiary" required="required" />
				<br>

				<form:errors class="alert alert-danger" role="alert" path="benificiary"></form:errors>

			</div>

			<div class="form-group">
				<label for="noOfVolunteers">Number of Volunteers</label>
				<form:input path="noOfVolunteers" placeholder="Enter the number of Volunteers" class="form-control"
					id="noOfVolunteers" required="required"></form:input>
				<br>

				<form:errors class="alert alert-danger" role="alert" path="noOfVolunteers">Only be a number
				</form:errors>
			...
			<div class="form-group">
				...
				<form:input path="costEstimate" placeholder="Enter the Estimated Cost" class="form-control"
					id="costEstimate" required="required"></form:input>
				<br>

				<form:errors class="alert alert-danger" role="alert" path="costEstimate"></form:errors>
	...
	<nav class="navbar fixed-bottom navbar-expand-md navbar-dark" style="background-color: #0033A0;">
		<footer> <a href="#" style="float: right; margin-left: 750px; color: #00B242;">Back
