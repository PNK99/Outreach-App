    ...
    <div class="container container-width">
        ...
        <form:form modelAttribute="event" action="createdEvent" method="post">
            <div class="form-group">
                ...
                <form:select placeholder="Select an activity" items="${activityList}" path="activity" id="activity"
                    class="form-control"></form:select>
            </div>
            <div class="form-group">
                <label for="place">Places</label>
                <form:input path="place" placeholder="Enter the venue place" class="form-control" id="place" required />
            </div>
            <div class="form-group">
                <label for="date">Date</label>
                <form:input path="date" type="date" class="form-control" id="date" required />
            </div>
            <div class="form-group">
