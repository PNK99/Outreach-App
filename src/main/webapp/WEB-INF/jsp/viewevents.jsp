  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
	...
	<div class="container container-width">
		...
		<div class="d-flex justify-content-between">
			...
			</span> <span> <span> <a class="btn btn-primary btn-sm" data-toggle="collapse" href="#multiCollapseExample1"
						role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Filter</a>
				</span>
				<c:if test='${!userRole.equalsIgnoreCase("Admin")}'>

					<span> <a class="btn btn-primary btn-sm" href="/yourEvents?userId=${user.id}">Your events</a>
					</span>
				</c:if>
				<c:if test='${userRole.equalsIgnoreCase("Admin")}'>
			...
			<div class="modal fade" id="exampleModalScrollable" role="dialog"
				...
				<div class="modal-dialog modal-dialog-scrollable" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">Please read the Do's and Dont's before you subscribe</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
							<a class="btn btn-success"
								href="viewEventDetails?eventId=${event.id}&userId=${user.id}">View</a>
				...
				<div class="card-header d-flex justify-content-between" style="font-size: 20px; font-weight: bold;">
					...
					<c:if test='${!userRole.equalsIgnoreCase("Admin")}'>
						<c:if test="${!event.volunteers.contains(userI)}">
							<a class="btn btn-success" href="viewEventDetails?eventId=${event.id}&userId=${user.id}"
								style="color: #FFFFFF">View</a>
