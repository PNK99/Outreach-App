  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
	...
	<div class="container container-width">
		...
		<div class="collapse multi-collapse" id="multiCollapseExample1"
			...
			<form:form action="viewEvents" method="get"
			...
			<div class="card" style="margin: 1%">
					...
					<c:if test='${!userRole.equalsIgnoreCase("Admin")}'>
						<c:if test="${!event.volunteers.contains(userI)}">
							<a class="btn btn-success" data-toggle="modal"
								data-target="#exampleModalScrollable" style="color:#FFFFFF">Subscribe</a>
							<div class="modal fade" id="exampleModalScrollable" tabindex="-1"
								...
								<div class="modal-dialog modal-dialog-scrollable"
									...
									<div class="modal-content">
										...
										<div class="modal-body">Please read the Do's and Dont's</div>
				...
				<div class="card-body">
					<div style="display: flex; justify-content: space-between;">
						<span><span style="font-weight: bold;"> Venue: </span> <c:out
								value="${event.place}" /> </span> <span> <span
							style="font-weight: bold;">Date: </span> <fmt:formatDate
								value="${event.date}" pattern="dd MMM yyyy EEE" />
						</span> <span><span style="font-weight: bold;">No of
								Volunteers: </span> <c:out value="${event.volunteers.size()}" /></span>
					</div>
				</div>
			</div>
